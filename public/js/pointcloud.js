...
class PointCloudExtension extends Autodesk.Viewing.Extension {
    constructor(viewer, options) {
        ...
        this.xaxisOffset = -0.50; // [office model]
        this.yaxisOffset = -0.50; // [office model]
        //this.xaxisOffset = 0; // [computer lab]
        //this.yaxisOffset = 0; // [computer lab]
        this.zaxisOffset = -0.8;
    ...
    _renderCloud(){
        ...
        this.points.scale.set(110,72, 10); //Match size with project size. (unit: inch) [computer lab]
    ...
    _viewSimulation(messages) {
        ...
        for (var i = 0; i < messages.length; i++) {
            ...
            //var concRange = {min:250, mid:450, max:690};
